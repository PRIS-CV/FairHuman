...
ADAPTER_PATH="/nvfile-heatstorage/zangxh/intern/wangyx/models/sdxl/adapter/"
OUTPUT_DIR="/nvfile-heatstorage/zangxh/intern/wangyx/models/sdxl/adapter/20250313_train_adapter_sdxl_fg"
...
CUDA_VISIBLE_DEVICES=1 python ./examples/t2i_adapter/train_t2i_adapter_sdxl_mpd_fair.py \
